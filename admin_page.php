...
<body>
    ...
    <!--addmin dashboard session starts-->
        ...
        <h1 class="title">bảng điều khiển</h1>
         <div class="box-container">
            <div class="box">
                ...
                ?>
                <h3><?php echo $total_pendings; ?>&nbspđ</h3>
                <p>Chờ xác nhận</p>
            </div>
            ...
            <div class="box">
                ...
                ?>
                <h3><?php echo $total_completed;?>&nbspđ</h3>
                <p>Đã xác nhận</p>
            </div>
            ...
            <div class="box">
                <?php
                    ...
                    $number_of_product = mysqli_num_rows($select_products);
                ?>
